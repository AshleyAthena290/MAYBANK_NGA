#!/usr/bin/env python3
"""Generate and save API validation test cases to artifacts directories"""
...
print("=" * 100)
print("GENERATING TEST CASES FOR ARTIFACTS")
print("=" * 100)
...
# Save markdown
markdown_file = os.path.join(markdown_dir, 'DEP_App_Dashboard_DDD_API_Design_v1_Test_Cases.md')
...
# Save Excel file
excel_file = os.path.join(excel_dir, 'DEP_App_Dashboard_DDD_API_Design_v1_Test_Cases.xlsx')
wb.save(excel_file)
